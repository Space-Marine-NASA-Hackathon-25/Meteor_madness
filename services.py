...
import folium
from service_helpers.consequences import *
...
def sim_orbit_n_conseq(des=DES):
    ...
    S_val = S(1.225, v_mag * 1000)
    rho_frag = fragmentation_density(S_val, v_mag * 1000)
    p_frag = dynamic_pressure(rho_frag, v_mag * 1000)
...
def draw_crater(map_obj, lat, lon, kinetic_energy):
    crater_radius = (kinetic_energy / (4.3e14)) ** 0.25
